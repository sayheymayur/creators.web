...
// don't exist in this react-icons version.

export const Users = Fi.FiUsers;
...
export const User = Fi.FiUser;
export const LayoutDashboard = Fi.FiLayout;

export const CheckCircle = Fi.FiCheckCircle;
...
export const Search = Fi.FiSearch;
export const Mail = Fi.FiMail;
export const Camera = Fi.FiCamera;
export const EyeOff = Fi.FiEyeOff;
export const Play = Fi.FiPlay;
export const Calendar = Fi.FiCalendar;
export const Chrome = Fi.FiChrome;

export const ArrowUpRight = Fi.FiArrowUpRight;
export const ArrowLeft = Fi.FiArrowLeft;
export const ArrowDownLeft = Fi.FiArrowDownLeft;
export const CreditCard = Fi.FiCreditCard;
export const RefreshCw = Fi.FiRefreshCcw;

export const Sparkles = Fi.FiZap;

export const Grid3x3 = Fi.FiGrid;
...
export const ChevronRight = Fi.FiChevronRight;

export const Radio = Fi.FiRadio;
export const Gift = Fi.FiGift;

export const Save = Fi.FiSave;

export const Mic = Fi.FiMic;
export const MicOff = Fi.FiMicOff;
export const VideoOff = Fi.FiVideoOff;
export const Volume2 = Fi.FiVolume2;
...
export const PhoneOutgoing = Fi.FiPhoneOutgoing;

export const SlidersHorizontal = Fi.FiSliders;
